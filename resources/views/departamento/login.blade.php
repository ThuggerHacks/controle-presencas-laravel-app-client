...
@section("content")
    <form action="#" method="post" action={{ route("dep.login") }}>
        @csrf
        <div class="content-uz">
            ...
            <div class="container card col-md-3 com-md-12 p-4 ">
                ...
                <div class="input-group">
                    ...
                    <input type="email" name="email" id="numero" placeholder="Seu email" class="form-control border-start-0">
                </div>
                <br/>
                <div class="input-group">
                    <span class="input-group-text bg-transparent border-end-0" id="basic-addon1">
                    ...
                    <input type="password" name="password" id="senha" placeholder="Sua senha" class="form-control border-start-0">
                </div>
                <br/>
